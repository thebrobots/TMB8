...
module.exports = {
  ...
  execute(message, args) {
    ...
    if (args[0] > queue.songs.length)
      return message.channel.send(`<:sh_playlist:799392374869852161>  The queue is only ${queue.songs.length} songs long!`).catch(console.error);
    ...
    queue.textChannel.send(`<:sh_skip:799392380750659604> Skipped ${args[0] - 1} songs`).catch(console.error);
  }
};
