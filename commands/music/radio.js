...
**34: ** [\`${Radiostations[34 - 1].split(" ")[0]}\`](${Radiostations[34 - 1].split(" ")[1]})`, inline: true
    ...
    return message.channel.send(`<:sh_bot:799392372009467935> You must be in the same channel as ${message.client.user}`)
    //check permissions
    ...
    */
    ...
    if (serverQueue) {
      ...
      const newsong = new MessageEmbed()
        ...
        .setColor(message.guild.me.displayHexColor === "#000000" ? "#f8f35f" : message.guild.me.displayHexColor)
